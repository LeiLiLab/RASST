...
\caption{Quality–latency trade-off of \method and baselines on the ACL 60/60 dev set. Quality is measured by both terminology accuracy and BLEU. Across all three language directions, \method improves terminology accuracy over InfiniSST by at least 10\% while also achieving higher translation quality.}
...
\caption{Quality–latency trade-off of \method and baselines on the ESO test set. Quality is measured by both terminology accuracy and BLEU. Across all three language directions, \method improves terminology accuracy over InfiniSST by nearly 40\% while also achieving slightly higher translation quality.}
