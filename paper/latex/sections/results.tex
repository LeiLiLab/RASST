...
On ACL 60/60, \method achieves higher BLEU than InfiniSST in 10 of the 12 settings, with a maximum gain of 3 BLEU points. By contrast, the two systems obtain comparable XCOMET scores. One likely explanation is that \method inserts retrieved target terms verbatim, which is more favored by a surface-form metric such as BLEU than by a neural semantic metric such as XCOMET. Moreover, although aligned target terms occur in 83.76--86.54\% of ACL sentences, they constitute only 10.66--18.06\% of the target tokens. Improvements in terminology accuracy therefore affect a limited proportion of the corpus, although expert evaluation frameworks explicitly treat terminology errors as a distinct source of translation quality degradation~\citep{freitag-etal-2021-experts}.
...
\bottomrule
\end{tabular}
\caption{End-to-end ablation of retrieval strategies on ACL En--Zh at latency multiplier 2. Decoding uses temperature 0.6.}
