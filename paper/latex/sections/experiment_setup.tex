...
\caption{Quality--latency trade-off on ACL 60/60. X-axis is latency measured by StreamLAAL in milisecond. Y-axis is quality measured by terminology accuracy (exact match), BLEU and XCOMET-XXL. \method improves terminology accuracy and BLEU in all three directions.}
