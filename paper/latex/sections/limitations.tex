...
Fifth, retrieval can help only when the required entry is present in the supplied glossary. The paper-derived-glossary test covers 23.95\% of the human glossary and accordingly yields much smaller gains. 
