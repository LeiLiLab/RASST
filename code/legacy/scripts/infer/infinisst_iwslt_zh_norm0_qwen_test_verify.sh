...
ROOT=/compute/babel-14-5/siqiouya/iwslt25/test
lang_code=zh
lang=Chinese
...
simuleval \
    ...
    --target-lang ${lang} \
    --min-start-sec ${ms} \
    --source ${ROOT}/../acl_6060/dev.source \
    --target ${ROOT}/../acl_6060/dummy.target  \
    --output ${save_dir}/iwslt25_test_verify/cache${max_llm_cache_size}_seg${src_segment_size}_beam${beam}_ms${ms}_nrnl${no_repeat_ngram_lookback}_nrns${no_repeat_ngram_size} \
