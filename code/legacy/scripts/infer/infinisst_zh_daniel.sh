...
state_dict_path="/compute/babel-5-23/siqiouya/runs/gigaspeech/en-zh/stage1_M=12_norm0_qwen_rope/last.ckpt/pytorch_model.bin"
lora_path="/compute/babel-5-23/siqiouya/runs/gigaspeech/en-zh/stage2_M=12_norm0_qwen_rope/last.ckpt/pytorch_model.bin"
lora_rank=32
save_dir=result
