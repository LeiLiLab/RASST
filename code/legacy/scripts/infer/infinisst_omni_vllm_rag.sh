...
#SBATCH -e /mnt/taurus/home/jiaxuanluo/InfiniSST/scripts/infer/logs/infer_infinisst_omni_vllm_rag_%A_%a.err
#SBATCH -o /mnt/taurus/home/jiaxuanluo/InfiniSST/scripts/infer/logs/infer_infinisst_omni_vllm_rag_%A_%a.out
...
export VLLM_USE_V1=0  # ⚠️ Force use v0 engine instead of v1 (more stable)
...
OUTPUT_DIR="/mnt/gemini/data2/jiaxuanluo/infinisst_omni_vllm_rag_acl6060"
mkdir -p "${OUTPUT_DIR}"
...
RUN_TAG="omni_vllm_rag_seg${SRC_SEGMENT_SIZE}_lm${LATENCY_MULTIPLIER}_maxnt${MAX_NEW_TOKENS}_tp${TOP_P}_tk${TOP_K}"
