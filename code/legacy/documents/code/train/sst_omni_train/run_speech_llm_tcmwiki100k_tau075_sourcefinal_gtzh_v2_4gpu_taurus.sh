#!/usr/bin/env bash
#SBATCH --job-name=slm_tcmw100k_v2
...
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_slm_tcmw100k_v2_taurus.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_slm_tcmw100k_v2_taurus.err
...
NOTES_FILE="${ROOT_DIR}/documents/code/train/sst_omni_train/notes_speech_llm_tcmwiki100k_tau075_sourcefinal_gtzh_v2.md"
...
SAVE_BASE="/mnt/gemini/data/jiaxuanluo/speech_llm_tcm_filtered_wiki100kgt_tau075_v2_sourcefinal_gtzh"
TRAIN_LOG_DIR="${ROOT_DIR}/documents/logs/speech_llm_tcmwiki100kgt_tau075_v2_taurus"
...
# Override this at sbatch time if Taurus has a cleaner 4-GPU set.
# Use HOST_GPU_DEVICES_OVERRIDE_CSV=0:2:3:5 with sbatch --export to avoid
# comma-splitting in Slurm's export parser.
...
WANDB_EXP_PREFIX="speech-llm-tcmw100kgt-v2-srcfinal-gtzh-taurus" \
