...
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_slm_tcmw100kgt.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_slm_tcmw100kgt.err
...
TRAIN_LOG_DIR="${ROOT_DIR}/documents/logs/speech_llm_tcmwiki100kgt_tau075"
...
ALLOCATED_GPUS="${CUDA_VISIBLE_DEVICES:-0,1,2,3}"
...
WANDB_EXP_PREFIX="speech-llm-tcmwiki100kgt-tau075" \
