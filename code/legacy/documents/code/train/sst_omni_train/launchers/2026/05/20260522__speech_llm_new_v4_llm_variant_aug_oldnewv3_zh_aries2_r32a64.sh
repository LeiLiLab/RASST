#!/usr/bin/env bash
# 2-GPU Speech LLM SFT launcher for New V4 on old new_v3 data, r32/a64.
set -euo pipefail
...
NOTES_FILE="${NOTES_FILE_OVERRIDE:-${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260522__speech_llm_new_v4_llm_variant_aug_oldnewv3_zh_r32a64.md}"
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/aries/data7/jiaxuanluo/slm/speech_llm_new_v4_llm_variant_aug_oldnewv3_zh_r32a64_aries2}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/logs/speech_llm_new_v4_llm_variant_aug_oldnewv3_zh_r32a64_aries2}"
...
WANDB_EXP_PREFIX="${WANDB_EXP_PREFIX_OVERRIDE:-speech-llm-new_v4-llmvariant-oldnewv3-r32a64-aries2}" \
