#!/usr/bin/env bash
# 2-GPU Speech LLM SFT launcher for V7 refmatch R95 term_map data.
set -euo pipefail
...
NOTES_FILE="${NOTES_FILE_OVERRIDE:-${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260521__speech_llm_v7_refmatch_r95_zh_r8a32.md}"
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/gemini/data2/jiaxuanluo/speech_llm_v7_refmatch_r95_termmap_zh_lh1b88kw_tau073_srcmatch100k_r8a32_taurus2}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-${ROOT_DIR}/documents/logs/speech_llm_v7_refmatch_r95_zh_r8a32_taurus2}"
...
TAGS=(
  ...
  "task:train"
  "data:v7_r95_zh"
  "variant:${WANDB_VARIANT_TAG_OVERRIDE:-v7_r95_r8a32}"
  "status:running"
  "compute:taurus2"
)
...
WANDB_EXP_PREFIX="${WANDB_EXP_PREFIX_OVERRIDE:-speech-llm-v7-r95-zh-r8a32-taurus2}" \
