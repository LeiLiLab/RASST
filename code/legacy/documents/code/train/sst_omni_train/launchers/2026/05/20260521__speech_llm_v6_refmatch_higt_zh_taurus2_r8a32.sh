#!/usr/bin/env bash
# 2-GPU Speech LLM SFT launcher for V6 refmatch high-GT term_map data.
set -euo pipefail
...
DATASET_PATH="${DATASET_PATH_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/speech_llm_v6_refmatch_higt_termmap_zh_lh1b88kw_tau073_srcmatch100k_20260521/train_s_zh_v6_refmatch_higt_termmap_lh1b88kw_tau073_srcmatch100k.jsonl}"
VAL_DATASET="${VAL_DATASET_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/speech_llm_v6_refmatch_higt_termmap_zh_lh1b88kw_tau073_srcmatch100k_20260521/dev_s_zh_v6_refmatch_higt_termmap_lh1b88kw_tau073_srcmatch100k.jsonl}"
NOTES_FILE="${NOTES_FILE_OVERRIDE:-${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260521__speech_llm_v6_refmatch_higt_zh_r8a32.md}"
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/gemini/data2/jiaxuanluo/speech_llm_v6_refmatch_higt_termmap_zh_lh1b88kw_tau073_srcmatch100k_r8a32_taurus2}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-${ROOT_DIR}/documents/logs/speech_llm_v6_refmatch_higt_zh_r8a32_taurus2}"
...
TAGS=(
  ...
  "task:train"
  "data:v6_higt_zh"
  "variant:${WANDB_VARIANT_TAG_OVERRIDE:-v6_higt_r8a32}"
  "status:running"
  "compute:taurus2"
)
...
WANDB_EXP_PREFIX="${WANDB_EXP_PREFIX_OVERRIDE:-speech-llm-v6-higt-zh-r8a32-taurus2}" \
