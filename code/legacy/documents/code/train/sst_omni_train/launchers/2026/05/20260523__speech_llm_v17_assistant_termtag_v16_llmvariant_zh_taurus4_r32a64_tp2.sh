#!/usr/bin/env bash
# 4-GPU Speech LLM SFT launcher for V17 assistant term-tag data.
set -euo pipefail
...
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/aries/data7/jiaxuanluo/slm/speech_llm_v17_assistant_termtag_v16_llmvariant_zh_${RANK_TAG}_tp2_taurus4}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/logs/speech_llm_v17_assistant_termtag_v16_llmvariant_zh_${RANK_TAG}_tp2_taurus4}"
...
WANDB_EXP_PREFIX="${WANDB_EXP_PREFIX_OVERRIDE:-speech-llm-v17-assistant-termtag-v16llmvariant-zh-${RANK_TAG}-tp2-taurus4}" \
