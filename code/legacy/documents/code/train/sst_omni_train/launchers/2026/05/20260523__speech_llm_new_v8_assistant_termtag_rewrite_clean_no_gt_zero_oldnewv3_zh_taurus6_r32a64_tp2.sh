#!/usr/bin/env bash
# 6-GPU Speech LLM SFT launcher for New V8 assistant term-tag rewrite-clean on New V5 data.
set -euo pipefail
...
DATA_DIR="${DATA_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/speech_llm_new_v8_assistant_termtag_rewrite_clean_no_gt_zero_oldnewv3_zh_20260523}"
DATASET_PATH="${DATASET_PATH_OVERRIDE:-${DATA_DIR}/train_s_zh_new_v8_assistant_termtag_rewrite_clean_no_gt_zero_oldnewv3.jsonl}"
VAL_DATASET="${VAL_DATASET_OVERRIDE:-${DATA_DIR}/dev_s_zh_new_v8_assistant_termtag_rewrite_clean_no_gt_zero_oldnewv3.jsonl}"
NOTES_FILE="${NOTES_FILE_OVERRIDE:-${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260523__speech_llm_new_v8_assistant_termtag_rewrite_clean_no_gt_zero_oldnewv3_zh.md}"
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/aries/data7/jiaxuanluo/slm/speech_llm_new_v8_assistant_termtag_rewrite_clean_no_gt_zero_oldnewv3_zh_r32a64_tp2_taurus6}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/logs/speech_llm_new_v8_assistant_termtag_rewrite_clean_no_gt_zero_oldnewv3_zh_r32a64_tp2_taurus6}"
...
ALLOCATED_GPUS="${HOST_GPU_DEVICES_OVERRIDE:-${CUDA_VISIBLE_DEVICES:-0,1,2,3,4,5}}"
...
TAGS=(
  ...
  "task:train"
  "data:new_v8_termtag_rewrite_clean"
  "variant:new_v8_r32a64_tp2"
  "status:running"
  "compute:taurus6"
)
for tag in "${TAGS[@]}"; do
...
WANDB_EXP_PREFIX="${WANDB_EXP_PREFIX_OVERRIDE:-speech-llm-new_v8-termtag-rewrite-clean-oldnewv3-r32a64-tp2-taurus6}" \
