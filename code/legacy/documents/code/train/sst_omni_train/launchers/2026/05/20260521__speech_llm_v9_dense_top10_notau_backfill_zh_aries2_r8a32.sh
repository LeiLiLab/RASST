#!/usr/bin/env bash
# 2-GPU Speech LLM SFT launcher for V9 dense top10 no-tau retriever term_map data.
set -euo pipefail
...
DATASET_PATH="${DATASET_PATH_OVERRIDE:-${DATA_DIR}/train_s_zh_v9_dense_top10_notau_backfill_lh1b88kw_srcmatch100k.jsonl}"
VAL_DATASET="${VAL_DATASET_OVERRIDE:-${DATA_DIR}/dev_s_zh_v9_dense_top10_notau_backfill_lh1b88kw_srcmatch100k.jsonl}"
NOTES_FILE="${NOTES_FILE_OVERRIDE:-${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260521__speech_llm_v9_dense_top10_notau_backfill_zh_r8a32.md}"
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/aries/data7/jiaxuanluo/slm/speech_llm_v9_dense_top10_notau_backfill_zh_lh1b88kw_srcmatch100k_r8a32_aries2}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/logs/speech_llm_v9_dense_top10_notau_backfill_zh_r8a32_aries2}"
...
TAGS=(
  ...
  "task:train"
  "data:v9_top10_notau_zh"
  "variant:v9_dense_r8a32_aries2"
  "status:running"
  "compute:aries2"
)
for tag in "${TAGS[@]}"; do
...
WANDB_EXP_PREFIX="${WANDB_EXP_PREFIX_OVERRIDE:-speech-llm-v9-dense-top10-notau-zh-r8a32-aries2}" \
