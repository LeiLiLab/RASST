...
MCORE_ADAPTERS="${MCORE_ADAPTERS_OVERRIDE:-/mnt/aries/data7/jiaxuanluo/slm/speech_llm_v16_llm_variant_aug_retriever_timeline_zh_lh1b88kw_tau073_r32a64_tp2_m4096_aries2/keep1.0_r32/v0-20260523-053943}"
HF_OUTPUT_DIR="${HF_OUTPUT_DIR_OVERRIDE:-/mnt/aries/data6/jiaxuanluo/slm/speech_llm_v16_llm_variant_aug_retriever_timeline_zh_lh1b88kw_tau073_r32a64_tp2_m4096_aries2/keep1.0_r32/v0-20260523-053943-hf}"
