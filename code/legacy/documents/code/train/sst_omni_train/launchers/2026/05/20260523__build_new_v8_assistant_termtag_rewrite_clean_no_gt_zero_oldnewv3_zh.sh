...
OUT_DIR="${OUT_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/speech_llm_new_v8_assistant_termtag_rewrite_clean_no_gt_zero_oldnewv3_zh_20260523}"
...
TRAIN_OUT="${TRAIN_OUT_OVERRIDE:-${OUT_DIR}/train_s_zh_new_v8_assistant_termtag_rewrite_clean_no_gt_zero_oldnewv3.jsonl}"
DEV_OUT="${DEV_OUT_OVERRIDE:-${OUT_DIR}/dev_s_zh_new_v8_assistant_termtag_rewrite_clean_no_gt_zero_oldnewv3.jsonl}"

TRAIN_STATS="${OUT_DIR}/train_new_v8_assistant_termtag_rewrite_clean_stats.json"
DEV_STATS="${OUT_DIR}/dev_new_v8_assistant_termtag_rewrite_clean_stats.json"
TRAIN_SAMPLES="${OUT_DIR}/train_new_v8_assistant_termtag_rewrite_clean_samples.json"
DEV_SAMPLES="${OUT_DIR}/dev_new_v8_assistant_termtag_rewrite_clean_samples.json"
SUMMARY="${OUT_DIR}/new_v8_assistant_termtag_rewrite_clean_no_gt_zero_oldnewv3_summary.json"
...
summary = {
    "event": "new_v8_assistant_termtag_rewrite_clean_no_gt_zero_oldnewv3_zh",
