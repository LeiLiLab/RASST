#!/usr/bin/env bash
# 6-GPU Speech LLM SFT launcher for New V9 assistant term-tag delay-clean on New V5 data.
set -euo pipefail
...
DATA_DIR="${DATA_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/speech_llm_new_v9_assistant_termtag_delay_clean_no_gt_zero_oldnewv3_zh_20260523}"
DATASET_PATH="${DATASET_PATH_OVERRIDE:-${DATA_DIR}/train_s_zh_new_v9_assistant_termtag_delay_clean_no_gt_zero_oldnewv3.jsonl}"
VAL_DATASET="${VAL_DATASET_OVERRIDE:-${DATA_DIR}/dev_s_zh_new_v9_assistant_termtag_delay_clean_no_gt_zero_oldnewv3.jsonl}"
NOTES_FILE="${NOTES_FILE_OVERRIDE:-${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260523__speech_llm_new_v9_assistant_termtag_delay_clean_no_gt_zero_oldnewv3_zh.md}"
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/aries/data7/jiaxuanluo/slm/speech_llm_new_v9_assistant_termtag_delay_clean_no_gt_zero_oldnewv3_zh_r32a64_tp2_taurus6}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/logs/speech_llm_new_v9_assistant_termtag_delay_clean_no_gt_zero_oldnewv3_zh_r32a64_tp2_taurus6}"
...
TAGS=(
  ...
  "task:train"
  "data:new_v9_termtag_delay_clean"
  "variant:new_v9_r32a64_tp2"
  "status:running"
  "compute:taurus6"
)
for tag in "${TAGS[@]}"; do
...
WANDB_EXP_PREFIX="${WANDB_EXP_PREFIX_OVERRIDE:-speech-llm-new_v9-termtag-delay-clean-oldnewv3-r32a64-tp2-taurus6}" \
