#!/usr/bin/env bash
# 4-GPU Speech LLM SFT launcher for New V9 assistant term-tag delay-clean, ja.
set -euo pipefail
...
DATA_DIR="${DATA_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/speech_llm_new_v9_assistant_termtag_delay_clean_no_gt_zero_oldnewv3_ja_20260524}"
DATASET_PATH="${DATASET_PATH_OVERRIDE:-${DATA_DIR}/train_s_ja_new_v9_assistant_termtag_delay_clean_no_gt_zero_oldnewv3.jsonl}"
VAL_DATASET="${VAL_DATASET_OVERRIDE:-${DATA_DIR}/dev_s_ja_new_v9_assistant_termtag_delay_clean_no_gt_zero_oldnewv3_first355.jsonl}"

LORA_RANK="${LORA_RANK_OVERRIDE:-32}"
LORA_ALPHA="${LORA_ALPHA_OVERRIDE:-64}"
RANK_TAG="r${LORA_RANK}a${LORA_ALPHA}"
NOTES_FILE="${NOTES_FILE_OVERRIDE:-${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260524__speech_llm_new_v9_assistant_termtag_delay_clean_no_gt_zero_oldnewv3_ja_r32a64_tp2.md}"
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/slm/speech_llm_new_v9_assistant_termtag_delay_clean_no_gt_zero_oldnewv3_ja_${RANK_TAG}_tp2_taurus4}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/logs/speech_llm_new_v9_assistant_termtag_delay_clean_no_gt_zero_oldnewv3_ja_${RANK_TAG}_tp2_taurus4}"
...
TAGS=(
  ...
  "task:train"
  "data:new_v9_ja_termtag"
  "variant:new_v9_ja_${RANK_TAG}_tp2"
  "status:running"
  "compute:taurus4"
)
for tag in "${TAGS[@]}"; do
...
WANDB_EXP_PREFIX="${WANDB_EXP_PREFIX_OVERRIDE:-speech-llm-new_v9-termtag-delay-clean-oldnewv3-ja-${RANK_TAG}-tp2-taurus4}" \
