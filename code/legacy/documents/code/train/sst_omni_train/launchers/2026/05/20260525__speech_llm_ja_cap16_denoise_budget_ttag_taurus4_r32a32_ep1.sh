...
NOTES_FILE="${NOTES_FILE_OVERRIDE:-${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260525__speech_llm_ja_cap16_denoise_budget_ttag_r32a32_ep1_taurus4.md}"
...
HF_EXPORT_STAGE_ROOT="${HF_EXPORT_STAGE_ROOT_OVERRIDE:-/mnt/data1/jiaxuanluo/hf_export_stage/speech_llm_ja_cap16_denoise_budget_ttag_${RANK_TAG}_ep1_taurus4}"
HF_EXPORT_MIN_FREE_GB="${HF_EXPORT_MIN_FREE_GB_OVERRIDE:-90}"
HF_EXPORT_LOCAL_CACHE_ROOT="${HF_EXPORT_LOCAL_CACHE_ROOT_OVERRIDE:-/mnt/data1/jiaxuanluo/slm_cache/speech_llm_ja_cap16_denoise_budget_ttag_${RANK_TAG}_ep1_taurus4/keep1.0_r32}"
HF_EXPORT_LOCAL_LATEST_LINK="${HF_EXPORT_LOCAL_LATEST_LINK_OVERRIDE:-/mnt/data1/jiaxuanluo/slm_cache/speech_llm_ja_cap16_denoise_budget_ttag_${RANK_TAG}_ep1_taurus4/latest-hf}"
