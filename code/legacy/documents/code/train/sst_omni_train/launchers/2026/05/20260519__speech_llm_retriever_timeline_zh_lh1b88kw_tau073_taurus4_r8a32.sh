#!/usr/bin/env bash
#SBATCH --job-name=slm_rettm_zh_r8
...
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_slm_rettm_zh_r8.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_slm_rettm_zh_r8.err

set -euo pipefail

if [[ "${ALLOW_DEPRECATED_V1_SFT:-0}" != "1" ]]; then
  echo "[ERROR] This launcher points to deprecated V1 retriever-termmap data." >&2
  echo "[ERROR] The V1 glossary did not cover gt_terms_by_chunk, so this data is invalid for SFT." >&2
  echo "[ERROR] Use a GT-union V1b launcher after data QA passes." >&2
  exit 2
fi
...
NOTES_FILE="${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260519__speech_llm_retriever_timeline_zh_lh1b88kw_tau073_r8a32.md"

DATASET_PATH="/mnt/gemini/data1/jiaxuanluo/speech_llm_retriever_timeline_termmap_zh_lh1b88kw_tau073_20260519/train_s_zh_retriever_timeline_lh1b88kw_tau073_k10_lb1p92.jsonl"
VAL_DATASET="/mnt/gemini/data1/jiaxuanluo/speech_llm_retriever_timeline_termmap_zh_lh1b88kw_tau073_20260519/dev_s_zh_retriever_timeline_lh1b88kw_tau073_k10_lb1p92.jsonl"
SAVE_BASE="/mnt/gemini/data2/jiaxuanluo/speech_llm_retriever_timeline_termmap_zh_lh1b88kw_tau073_r8a32_taurus4"
TRAIN_LOG_DIR="${ROOT_DIR}/documents/logs/speech_llm_retriever_timeline_zh_lh1b88kw_tau073_r8a32_taurus4"
...
TAGS=(
  ...
  "task:train"
  "data:ret_tm_lh1_tau073"
  "variant:timeline_v1_r8a32"
  "status:running"
  "compute:taurus4"
)
...
WANDB_EXP_PREFIX="speech-llm-rettm-lh1tau073-zh-r8a32-taurus4" \
