#!/usr/bin/env bash
#SBATCH --job-name=slm_rettm_gu_r8
...
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_slm_rettm_gu_r8.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_slm_rettm_gu_r8.err
...
NOTES_FILE="${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260519__speech_llm_retriever_timeline_zh_lh1b88kw_tau073_gtunion_r8a32.md"
...
TRAIN_LOG_DIR="${ROOT_DIR}/documents/logs/speech_llm_retriever_timeline_zh_lh1b88kw_tau073_gtunion_r8a32_taurus4"
...
WANDB_EXP_PREFIX="speech-llm-rettm-lh1tau073-zh-gtunion-r8a32-taurus4" \
