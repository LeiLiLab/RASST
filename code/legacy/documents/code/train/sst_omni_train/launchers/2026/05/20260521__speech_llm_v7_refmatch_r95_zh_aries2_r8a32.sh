#!/usr/bin/env bash
# 2-GPU Speech LLM SFT launcher for V7 refmatch R95 term_map data on aries.
set -euo pipefail
...
DATASET_PATH="${DATASET_PATH_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/speech_llm_v7_refmatch_r95_termmap_zh_lh1b88kw_tau073_srcmatch100k_20260521/train_s_zh_v7_refmatch_r95_termmap_lh1b88kw_tau073_srcmatch100k.jsonl}"
VAL_DATASET="${VAL_DATASET_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/speech_llm_v7_refmatch_r95_termmap_zh_lh1b88kw_tau073_srcmatch100k_20260521/dev_s_zh_v7_refmatch_r95_termmap_lh1b88kw_tau073_srcmatch100k.jsonl}"
NOTES_FILE="${NOTES_FILE_OVERRIDE:-${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260521__speech_llm_v7_refmatch_r95_zh_r8a32_aries2.md}"
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/aries/data7/jiaxuanluo/slm/speech_llm_v7_refmatch_r95_zh_lh1b88kw_tau073_srcmatch100k_r8a32_aries2}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/logs/speech_llm_v7_refmatch_r95_zh_r8a32_aries2}"
...
ALLOCATED_GPUS="${HOST_GPU_DEVICES_OVERRIDE:-${CUDA_VISIBLE_DEVICES:-4,5}}"
...
TAGS=(
  ...
  "task:train"
  "data:v7_r95_zh"
  "variant:${WANDB_VARIANT_TAG_OVERRIDE:-v7_r95_r8a32_aries2}"
  "status:running"
  "compute:aries2"
)
...
WANDB_EXP_PREFIX="${WANDB_EXP_PREFIX_OVERRIDE:-speech-llm-v7-r95-zh-r8a32-aries2}" \
