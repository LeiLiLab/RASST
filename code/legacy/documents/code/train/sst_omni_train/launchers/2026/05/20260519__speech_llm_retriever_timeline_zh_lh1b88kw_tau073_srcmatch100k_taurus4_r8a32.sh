#!/usr/bin/env bash
#SBATCH --job-name=slm_rettm_srcm_r8
...
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_slm_rettm_srcm_r8.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_slm_rettm_srcm_r8.err
...
NOTES_FILE="${NOTES_FILE_OVERRIDE:-${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260519__speech_llm_retriever_timeline_zh_lh1b88kw_tau073_srcmatch100k_r8a32.md}"

DATASET_PATH="/mnt/gemini/data1/jiaxuanluo/speech_llm_retriever_timeline_termmap_zh_lh1b88kw_tau073_srcmatch100k_20260519/train_s_zh_retriever_timeline_lh1b88kw_tau073_srcmatch100k_k10_lb1p92.jsonl"
VAL_DATASET="/mnt/gemini/data1/jiaxuanluo/speech_llm_retriever_timeline_termmap_zh_lh1b88kw_tau073_srcmatch100k_20260519/dev_s_zh_retriever_timeline_lh1b88kw_tau073_srcmatch100k_k10_lb1p92.jsonl"
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/gemini/data2/jiaxuanluo/speech_llm_retriever_timeline_termmap_zh_lh1b88kw_tau073_srcmatch100k_r8a32_taurus4}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-${ROOT_DIR}/documents/logs/speech_llm_retriever_timeline_zh_lh1b88kw_tau073_srcmatch100k_r8a32_taurus4}"
...
ALLOCATED_GPUS="${HOST_GPU_DEVICES_OVERRIDE:-${CUDA_VISIBLE_DEVICES:-4,5,6,7}}"
...
TAGS=(
  ...
  "task:train"
  "data:srcmatch100k"
  "variant:${WANDB_VARIANT_TAG_OVERRIDE:-v2_srcm_r8a32}"
  "status:running"
  "compute:taurus4"
)
...
WANDB_EXP_PREFIX="${WANDB_EXP_PREFIX_OVERRIDE:-speech-llm-rettm-lh1tau073-zh-srcmatch100k-r8a32-taurus4}" \
