#!/usr/bin/env bash
# 2-GPU Speech LLM SFT launcher for V16 LLM-variant data with no-GT chunks zeroed.
set -euo pipefail
...
DATA_DIR="${DATA_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/speech_llm_v16_no_gt_zero_llm_variant_aug_retriever_timeline_zh_lh1b88kw_tau073_20260522}"
DATASET_PATH="${DATASET_PATH_OVERRIDE:-${DATA_DIR}/train_s_zh_v16_no_gt_zero_llm_variant_aug_tau073_k10_minctx2p88.jsonl}"
VAL_DATASET="${VAL_DATASET_OVERRIDE:-${DATA_DIR}/dev_s_zh_v16_no_gt_zero_llm_variant_aug_tau073_k10_minctx2p88_first200.jsonl}"
NOTES_FILE="${NOTES_FILE_OVERRIDE:-${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260522__speech_llm_v16_no_gt_zero_llm_variant_aug_zh_r8a32.md}"
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/aries/data7/jiaxuanluo/slm/speech_llm_v16_no_gt_zero_llm_variant_aug_retriever_timeline_zh_lh1b88kw_tau073_r8a32_aries2}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/logs/speech_llm_v16_no_gt_zero_llm_variant_aug_retriever_timeline_zh_r8a32_aries2}"
...
TAGS=(
  ...
  "task:train"
  "data:v16_no_gt_zero_zh"
  "variant:v16_no_gt_zero_r8a32"
  "status:running"
  "compute:aries2"
)
for tag in "${TAGS[@]}"; do
...
WANDB_EXP_PREFIX="${WANDB_EXP_PREFIX_OVERRIDE:-speech-llm-v16-no-gt-zero-zh-r8a32-aries2}" \
