#!/usr/bin/env bash
# 2-GPU Speech LLM SFT launcher for V10 marker-augmented dense top10 data.
set -euo pipefail
...
DATA_DIR="${DATA_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/speech_llm_v9_v10_dense_top10_notau_backfill_zh_lh1b88kw_srcmatch100k_20260521}"
DATASET_PATH="${DATASET_PATH_OVERRIDE:-${DATA_DIR}/train_s_zh_v10_dense_top10_notau_backfill_lh1b88kw_srcmatch100k.jsonl}"
VAL_DATASET="${VAL_DATASET_OVERRIDE:-${DATA_DIR}/dev_s_zh_v10_dense_top10_notau_backfill_lh1b88kw_srcmatch100k.jsonl}"
NOTES_FILE="${NOTES_FILE_OVERRIDE:-${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260521__speech_llm_v10_marker_dense_top10_notau_backfill_zh_r8a32.md}"
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/aries/data7/jiaxuanluo/slm/speech_llm_v10_marker_dense_top10_notau_backfill_zh_lh1b88kw_srcmatch100k_r8a32_aries2}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/logs/speech_llm_v10_marker_dense_top10_notau_backfill_zh_r8a32_aries2}"
...
TAGS=(
  ...
  "task:train"
  "data:v10_marker_top10_zh"
  "variant:v10_marker_r8a32_aries2"
  "status:running"
  "compute:aries2"
)
for tag in "${TAGS[@]}"; do
...
WANDB_EXP_PREFIX="${WANDB_EXP_PREFIX_OVERRIDE:-speech-llm-v10-marker-top10-notau-zh-r8a32-aries2}" \
