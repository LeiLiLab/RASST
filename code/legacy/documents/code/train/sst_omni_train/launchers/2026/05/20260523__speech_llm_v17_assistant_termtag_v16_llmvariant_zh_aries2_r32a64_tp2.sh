#!/usr/bin/env bash
# 2-GPU Speech LLM SFT launcher for V17 assistant term-tag data.
set -euo pipefail
...
DATA_DIR="${DATA_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/speech_llm_v17_assistant_termtag_v16_llmvariant_zh_20260523}"
DATASET_PATH="${DATASET_PATH_OVERRIDE:-${DATA_DIR}/train_s_zh_v17_assistant_termtag_v16_llmvariant_tau073_k10_minctx2p88.jsonl}"
VAL_DATASET="${VAL_DATASET_OVERRIDE:-${DATA_DIR}/dev_s_zh_v17_assistant_termtag_v16_llmvariant_tau073_k10_minctx2p88_first200.jsonl}"

LORA_RANK="${LORA_RANK_OVERRIDE:-32}"
LORA_ALPHA="${LORA_ALPHA_OVERRIDE:-64}"
RANK_TAG="r${LORA_RANK}a${LORA_ALPHA}"
NOTES_FILE="${NOTES_FILE_OVERRIDE:-${ROOT_DIR}/documents/code/train/sst_omni_train/notes/2026/05/20260523__speech_llm_v17_assistant_termtag_v16_llmvariant_zh_r32a64_tp2.md}"
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/aries/data7/jiaxuanluo/slm/speech_llm_v17_assistant_termtag_v16_llmvariant_zh_${RANK_TAG}_tp2_aries2}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/logs/speech_llm_v17_assistant_termtag_v16_llmvariant_zh_${RANK_TAG}_tp2_aries2}"
...
ALLOCATED_GPUS="${HOST_GPU_DEVICES_OVERRIDE:-${CUDA_VISIBLE_DEVICES:-6,7}}"
...
TAGS=(
  ...
  "task:train"
  "data:v17_assistant_termtag_zh"
  "variant:v17_assistant_termtag_${RANK_TAG}_tp2"
  "status:running"
  "compute:aries2"
)
for tag in "${TAGS[@]}"; do
...
WANDB_EXP_PREFIX="${WANDB_EXP_PREFIX_OVERRIDE:-speech-llm-v17-assistant-termtag-v16llmvariant-zh-${RANK_TAG}-tp2-aries2}" \
