#!/bin/bash
#SBATCH --job-name=q3_smoke_E_hcl1
...
#SBATCH --gres=gpu:1
#SBATCH --time=0:40:00
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_smoke_E_hcl1_%x.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_smoke_E_hcl1_%x.err
...
# --- Loss flags (variant E-HCL1 counterpart: HCL beta=1 for head-to-head
# comparison with HCL=0 smoke under identical LR schedule + refresh freq) ---
HCL_BETA="1.0"
TCM_LOSS_WEIGHT="1.0"
...
VERSION="smoke_E_hardneg_hcl1_tcm"
