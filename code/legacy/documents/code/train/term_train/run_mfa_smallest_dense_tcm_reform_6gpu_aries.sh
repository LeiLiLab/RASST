...
#     Memory: at B=1536 W=230 D=1024 bf16 the max-sim tensor ~0.70 GB/rank
...
# --- Data-side hard-neg (KEPT at 43848 pool k=64 to isolate TCM axis) ---
HARD_NEG_K=64
...
TASK_TAG="train"
EXTRA_WANDB_TAGS="variant:tcm5x_relaxed_smallest_dense_normAGGR_8gpu compute:aries-8gpu"
BASELINE_RUN_IDS="zv28ve3q"
# ======Configuration=====
...
VERSION="3var_clean_gc_wr$((WIKI_RANK / 1000))k_m${MARGIN}_maxsim_mfa_variantE_hardneg_k${HARD_NEG_K}_tcm5x_b070_a040_ep${EPOCHS}_cold_smallest_dense_normAGGR_8gpu${SMOKE_TAG}"
SAVE_NAME="q3rag_${MODE_NAME}_bs${BS_ABBR}_t=${TEMPERATURE}_${VERSION}"
SAVE_PATH="${SAVE_DIR}/${SAVE_NAME}.pt"
WANDB_EXP_NAME="variantE_k${HARD_NEG_K}_tcm5x_b070_a040_smallest_dense_normAGGR_8gpu_${SAVE_NAME}"

echo "[TRAIN] VARIANT=E_k${HARD_NEG_K}_tcm5x_b070_a040_smallest_dense_normAGGR_8gpu"
...
echo "[TRAIN] Variant E TCM5x relaxed (beta=0.70 alpha=0.40) k${HARD_NEG_K} smallest+dense 8GPU completed at $(date)"
