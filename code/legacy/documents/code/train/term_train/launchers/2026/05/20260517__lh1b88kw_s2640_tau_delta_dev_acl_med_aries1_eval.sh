#!/bin/bash
#SBATCH --job-name=q3_lh1b88kw_tau_delta
...
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_lh1b88kw_tau_delta_%x.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_lh1b88kw_tau_delta_%x.err
...
export VARIANT_TAG="lh1b88kw_s2640_tau_delta"
export VERSION="3var_gsdedup_vctx576_lh1b88kw_s2640_tau_delta_${COMPUTE_TAG}"
export WANDB_EXP_NAME="lh1b88kw_s2640_tau_delta_dev_acl_med_${COMPUTE_TAG}_20260517"
export NOTES_FILE="/mnt/taurus/home/jiaxuanluo/InfiniSST/documents/code/train/term_train/notes/2026/05/20260517__lh1b88kw_s2640_tau_delta_dev_acl_med_eval.md"
...
export DATA_TAG="vctx576_lh1b88kw_tau_delta"
export EXPERIMENT_FAMILY="sst_ood_hardneg"
export EXTRA_WANDB_TAGS="variant:${VARIANT_TAG} compute:${COMPUTE_TAG} calibration:dev_delta readout:acl_med"
export BASELINE_RUN_IDS="lh1b88kw"
...
export MASTER_PORT="${MASTER_PORT:-30358}"
...
#   tau selection.
# - ACL6060 and medicine are readouts only and must not be used for selection.
...
export RUN_VERDICT="Eval-only tau-delta sweep for lh1b88kw secondary checkpoint. Select tau from dev base/gs10k/gs100k recall retention; ACL6060 and medicine are readout only."

echo "[TAU_DELTA_EVAL] ckpt=${RESUME}"
echo "[TAU_DELTA_EVAL] dev=${DEV_JSONL} glossary=${EVAL_WIKI_GLOSSARY} sizes=${EVAL_GLOSSARY_SIZES}"
echo "[TAU_DELTA_EVAL] acl=${ACL_DEV_JSONL} glossary=${ACL_EVAL_WIKI_GLOSSARY} sizes=${ACL_EVAL_GLOSSARY_SIZES}"
echo "[TAU_DELTA_EVAL] medicine=${MEDICINE_DEV_JSONL} glossary=${MEDICINE_EVAL_WIKI_GLOSSARY} sizes=${MEDICINE_EVAL_GLOSSARY_SIZES}"
echo "[TAU_DELTA_EVAL] tau_grid=${TCM_SWEEP_THRESHOLDS}"
echo "[TAU_DELTA_EVAL] compute=${COMPUTE_TAG}"
