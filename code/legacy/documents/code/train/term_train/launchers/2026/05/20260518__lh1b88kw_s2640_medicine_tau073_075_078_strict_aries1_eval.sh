#!/bin/bash
#SBATCH --job-name=q3_lh1b88kw_med_tau3
...
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_lh1b88kw_med_tau3_%x.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_lh1b88kw_med_tau3_%x.err
...
export VARIANT_TAG="${VARIANT_TAG:-lh1b88kw_s2640_medicine_tau073_075_078_strict}"
export VERSION="${VERSION:-3var_gsdedup_vctx576_lh1b88kw_s2640_medicine_tau073_075_078_strict_${COMPUTE_TAG}}"
export WANDB_EXP_NAME="${WANDB_EXP_NAME:-lh1b88kw_s2640_medicine_tau073_075_078_strict_${COMPUTE_TAG}_${RUN_STAMP}}"
export NOTES_FILE="${NOTES_FILE:-/mnt/taurus/home/jiaxuanluo/InfiniSST/documents/code/train/term_train/notes/2026/05/20260518__lh1b88kw_s2640_medicine_tau073_075_078_strict_eval.md}"
...
export DATA_TAG="${DATA_TAG:-vctx576_lh1b88kw_medicine_strict_tau3}"
export EXPERIMENT_FAMILY="sst_ood_hardneg"
export EXTRA_WANDB_TAGS="${EXTRA_WANDB_TAGS:-variant:${VARIANT_TAG} compute:${COMPUTE_TAG} readout:medicine_strict calibration:dev_tau_reuse}"
export BASELINE_RUN_IDS="${BASELINE_RUN_IDS:-lh1b88kw 4g108a3w 614b3nbi}"
...
export MASTER_PORT="${MASTER_PORT:-30382}"

export EVAL_WIKI_GLOSSARY="${EVAL_WIKI_GLOSSARY:-/mnt/gemini/home/jiaxuanluo/medicine_eval_varctx2p88_3p84_4p80_5p76_clean_mfa_exact_only/medicine_glossary_gt_plus_medicine_wiki_gs10000.json}"
...
export RUN_VERDICT="${RUN_VERDICT:-Medicine-only strict MFA readout for lh1b88kw step-2640 at tau 0.73/0.75/0.78. Tau choices reuse the prior dev calibration; no dev/ACL/tagged ACL scoring is run here.}"

echo "[MEDICINE_TAU3_EVAL] ckpt=${RESUME}"
echo "[MEDICINE_TAU3_EVAL] medicine=${MEDICINE_DEV_JSONL}"
echo "[MEDICINE_TAU3_EVAL] glossary=${MEDICINE_EVAL_WIKI_GLOSSARY} sizes=${MEDICINE_EVAL_GLOSSARY_SIZES}"
echo "[MEDICINE_TAU3_EVAL] tau_grid=${TCM_SWEEP_THRESHOLDS}"
echo "[MEDICINE_TAU3_EVAL] compute=${COMPUTE_TAG}"
