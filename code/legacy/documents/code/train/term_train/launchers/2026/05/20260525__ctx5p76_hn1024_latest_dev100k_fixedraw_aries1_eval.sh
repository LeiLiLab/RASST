...
export RUN_STAMP="${RUN_STAMP:-ctx5p76_hn1024_latest_dev100k_fixedraw_aries_gpu0_20260525T005027Z}"
export MODEL_TAG="hn1024_ctx5p76_latest_s1300"
export VARIANT_TAG="hn1024_ctx5p76_latest_s1300_dev100k_fixedraw"
export VERSION="3var_gsv2full_gsdedup_ctx5p76_hn1024_latest_s1300_dev100k_fixedraw_${RUN_STAMP}"
export WANDB_EXP_NAME="variantE_hn1024_ctx5p76_latest_s1300_dev100k_fixedraw_${RUN_STAMP}"
export DATA_TAG="ctx5p76_dev100k_fixedraw"
export EXPERIMENT_FAMILY="sst_ood_hardneg_eval_compare"
export TASK_TAG="eval"
export EXTRA_WANDB_TAGS="variant:hn1024_ctx5p76_latest_s1300_dev100k_fixedraw compute:aries-gpu0-shared source:jyb2u787 checkpoint:latest_s1300 protocol:dev-fixedraw readout:dev-only"
export BASELINE_RUN_IDS="jyb2u787 zseptpl0 lh1b88kw"

export CUDA_DEVICE_LIST="${CUDA_DEVICE_LIST:-0}"
export NUM_GPUS=1
export PER_GPU_BATCH=1
export BATCH_SIZE=1
export MASTER_PORT="${MASTER_PORT:-20047}"
export SELECT_CLEAN_GPUS=false
export WAIT_FOR_CLEAN_GPUS=false
export LOCAL_TMP_DIR="${LOCAL_TMP_DIR:-/tmp/jiaxuanluo_q3_ctx5p76_dev100k_eval_${RUN_STAMP}}"
...
export NOTES_FILE="${REPO_ROOT}/documents/code/train/term_train/notes/2026/05/20260525__ctx5p76_hn1024_latest_dev100k_fixedraw_eval.md"
...
export RUN_VERDICT="Eval-only fixed 5.76s HN1024 latest checkpoint on ctx5p76 dev, fixed raw denominator, retriever banks base/1k/10k/100k. Dev only; ACL/tagged/medicine intentionally disabled."
