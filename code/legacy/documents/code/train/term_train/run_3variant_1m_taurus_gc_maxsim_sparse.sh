...
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_ms_sp.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_ms_sp.err

# Max-Sim + sparse_weight=0.7 full training.
# Windows [6,10,16,24] stride=2, text_pooling=cls.
# Taurus 7 GPUs, GradCache.
...
CUDA_VISIBLE_GPU_LIST="0,1,2,3,4,5,7"
...
RESUME_PATH="/mnt/data/jiaxuanluo/train_outputs/q3rag_scale_lora-r128-tr128_bs10752_t=0.03_3var_clean_gc_wr1000k_m0.1_maxsim_sp07_step_1000.pt"
...
# Text encoder: LoRA r128, CLS pooling, sparse=0.7
...
VERSION="3var_clean_gc_wr$((WIKI_RANK / 1000))k_m${MARGIN}_maxsim_sp07"
...
echo "[TRAIN] Max-Sim + sparse=0.7 full training (Taurus 7 GPUs, skip GPU6, resume from step 1000)"
echo "[TRAIN] Save: ${SAVE_PATH}"
echo "[TRAIN] MaxSim windows: ${MAXSIM_WINDOWS}, stride: ${MAXSIM_STRIDE}"
echo "[TRAIN] sparse_weight: ${SPARSE_WEIGHT}"
