...
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_mfa_maxsim.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_mfa_maxsim.err

# MFA-Supervised Multi-Scale Max-Sim training on Aries 8 GPUs.
# Same config as run_3variant_1m_aries_gc12k_maxsim.sh but with --mfa_supervised_maxsim
# and MFA-enriched training JSONL.
...
RESUME_PATH="/mnt/aries/data4/jiaxuanluo/train_outputs/q3rag_scale_lora-r128-tr128_bs12k_t=0.03_3var_clean_gc_wr1000k_m0.1_maxsim_mfa_step_300.pt"
...
VERSION="3var_clean_gc_wr$((WIKI_RANK / 1000))k_m${MARGIN}_maxsim_mfa"
...
echo "[TRAIN] MFA-Supervised Multi-Scale Max-Sim (Aries 8 GPUs)"
echo "[TRAIN] Data: ${TRAIN_JSONL}"
echo "[TRAIN] Save: ${SAVE_PATH}"
echo "[TRAIN] Batch: ${BATCH_SIZE} (${NUM_GPUS} GPUs * ${PER_GPU_BATCH})"
echo "[TRAIN] MaxSim windows: ${MAXSIM_WINDOWS}, stride: ${MAXSIM_STRIDE}, MFA supervised: ${MFA_SUPERVISED}"
