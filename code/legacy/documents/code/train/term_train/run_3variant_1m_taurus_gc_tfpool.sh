...
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_tfpool.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_tfpool.err

# Transformer Pooling ablation: train from scratch with 1-layer cross-attention
# pooling (learnable query) instead of scalar AttentivePooling.
# Taurus 6 GPUs, GradCache, margin=0.1, no O-HNM.
...
echo "[TRAIN] Transformer Pooling ablation (from scratch)"
