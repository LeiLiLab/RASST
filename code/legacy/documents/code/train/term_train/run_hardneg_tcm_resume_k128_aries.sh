#!/bin/bash
#SBATCH --job-name=q3_variantE_resume_k128
...
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_variantE_resume_k128_%x.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_variantE_resume_k128_%x.err
