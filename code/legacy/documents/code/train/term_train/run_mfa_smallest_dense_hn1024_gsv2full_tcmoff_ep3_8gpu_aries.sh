#!/bin/bash
#SBATCH --job-name=q3_hn1024_full_off3
...
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_hn1024_full_off3_%x.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_q3_hn1024_full_off3_%x.err

# Full GSV2 k=1024 TCM-off warm start for the TCM pair/weight sweep.

set -euo pipefail

export VARIANT_TAG="hn1024_gsv2full_tcmoff_ep3"
export VERSION="3var_gsv2full_gsfix_gc_wr1000k_m0.0_maxsim_mfa_variantE_hn1024_tcmoff_ep3_bs12k_smallest_dense_normAGGR_8gpu_aries"
export WANDB_EXP_NAME="variantE_hn1024_gsv2full_tcmoff_ep3_8gpu_aries"
export NOTES_FILE="/mnt/taurus/home/jiaxuanluo/InfiniSST/documents/code/train/term_train/notes_hn1024_gsv2full_tcmoff_ep3_aries.md"
...
export EPOCHS=3
# Keep the LR schedule open for the continuation epoch.
export SCHEDULER_EPOCHS=4
export MAX_STEPS=0
export MAX_TRAIN_SECONDS=0
export MASTER_PORT=29986
export DATA_TAG="3variant_gsv2full_gsfix_mfa"
export EXTRA_WANDB_TAGS="variant:hn1024_gsv2full_tcmoff_ep3 compute:aries-8gpu"
