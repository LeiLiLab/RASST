...
RUN_STAMP="${RUN_STAMP:-20260526T000000_origin_norag_de_lm4_batch_seq1_serialaligned_taurus}"
OUT_ROOT="${OUT_ROOT:-/mnt/data1/jiaxuanluo/tagged_acl_origin_norag_de_lm4_batch_seq1_serialaligned_${RUN_STAMP}}"
LOG_ROOT="${LOG_ROOT:-/mnt/data1/jiaxuanluo/logs/tagged_acl_origin_norag_de_lm4_batch_seq1_serialaligned_${RUN_STAMP}}"
CACHE_ROOT="${CACHE_ROOT:-/mnt/data1/jiaxuanluo/cache/tagged_acl_origin_norag_de_lm4_batch_seq1_serialaligned_${RUN_STAMP}}"
...
NOTES_FILE="${NOTES_FILE:-${ROOT_DIR}/documents/code/simuleval/notes/2026/05/20260526__tagged_acl_origin_norag_de_lm4_batch_seq1_serialaligned_taurus.md}"
PYTHON_BIN="${PYTHON_BIN:-/mnt/taurus/home/jiaxuanluo/miniconda3/envs/spaCyEnv/bin/python}"

GPU_PAIR="${GPU_PAIR:-2,3}"
EVAL_TMPDIR="${EVAL_TMPDIR:-/tmp/jxnoilm4s1}"
DENSITY_TAG="${DENSITY_TAG:-tagacl_origin_norag_batch_seq1_serialaligned_lm4}"
GLOSSARY_TAG="${GLOSSARY_TAG:-acl6060_tagged_gt_raw_min_norm2}"
OUTPUT_BASE="${OUT_ROOT}/origin_norag_de_lm4_batch_seq1_serialaligned"
...
main() {
...

  {
    ...
    echo "mode=batch_vllm_seq1_serial_by_lm"
...
summary = output_base / "__summary__" / "summary_de_lm4_seq1_serialaligned.tsv"
summary.parent.mkdir(parents=True, exist_ok=True)
fields = [
    "method", "lang", "lm", "mode", "max_num_seqs", "scheduler_batch_size",
    "schedule_mode", "max_new_tokens", "cache_seconds", "vllm_limit_audio",
    "BLEU", "StreamLAAL", "StreamLAAL_CA", "TERM_ACC", "TERM_CORRECT",
    "TERM_TOTAL", "source_path",
]
row = rows[0]
record = {
    ...
    "lang": "de",
    "lm": "4",
    "mode": "batch_vllm_seq1_serial_by_lm",
    "max_num_seqs": "1",
    "scheduler_batch_size": "1",
    "schedule_mode": "serial_by_lm",
    "max_new_tokens": "40",
    "cache_seconds": "80/60",
    "vllm_limit_audio": "20",
    "BLEU": row.get("BLEU", ""),
