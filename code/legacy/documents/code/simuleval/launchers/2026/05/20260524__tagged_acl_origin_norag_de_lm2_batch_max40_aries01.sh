...
# En-De tagged ACL raw lm=2 InfiniSST/no-RAG batch verification with max_new_tokens=40.

ROOT_DIR="${ROOT_DIR_OVERRIDE:-/mnt/taurus/home/jiaxuanluo/InfiniSST}"
cd "${ROOT_DIR}"

RUN_STAMP="${RUN_STAMP:-20260524T2220_tagacl_origin_norag_de_lm2_batch_max40_aries01}"
...
NOTES_FILE="${NOTES_FILE:-${ROOT_DIR}/documents/code/simuleval/notes/2026/05/20260524__tagged_acl_origin_norag_de_lm2_batch_max40_aries01.md}"

OUT_ROOT="${OUT_ROOT:-/mnt/gemini/data1/jiaxuanluo/tagged_acl_origin_norag_de_lm2_batch_max40_aries01_${RUN_STAMP}}"
OUTPUT_BASE="${OUTPUT_BASE:-${OUT_ROOT}/origin_norag_de_lm2_batch_max40}"
LOG_ROOT="${LOG_ROOT:-/mnt/gemini/data1/jiaxuanluo/logs/tagged_acl_origin_norag_de_lm2_batch_max40_aries01_${RUN_STAMP}}"
CACHE_BASE="${CACHE_BASE:-/mnt/gemini/data1/jiaxuanluo/cache/tagged_acl_origin_norag_de_lm2_batch_max40_aries01_${RUN_STAMP}}"
EVAL_TMPDIR="${EVAL_TMPDIR:-/tmp/jx_tacl_d2n40}"
...
WANDB_VARIANT_PREFIX_OVERRIDE="origin_norag_de_lm2_batch_max40" \
