...
# Runs on Aries GPU pair 2,3 while lm1/lm2/lm3 run on other pairs.
...
RUN_STAMP="${RUN_STAMP:-20260526T034148_tagacl_newv9_hn1024_tau000_raw_zh_lm4_aries23_parallel}"

MODEL_LABEL="${MODEL_LABEL:-new_v9_termtag_delay_oldnewv3_r32a64_hn1024_tau000_readout_lm4_aries23}"
...
NOTES_FILE="${NOTES_FILE:-${ROOT_DIR}/documents/code/simuleval/notes/2026/05/20260526T034148__tagged_acl_new_v9_hn1024_tau000_raw_zh_lm4_aries23_parallel.md}"

OUTPUT_STORAGE_ROOT="${OUTPUT_STORAGE_ROOT:-/mnt/taurus/data2/jiaxuanluo}"
OUT_ROOT="${OUT_ROOT:-${OUTPUT_STORAGE_ROOT}/tagged_acl_new_v9_hn1024_tau000_raw_zh_lm4_${RUN_STAMP}}"
LOG_ROOT="${LOG_ROOT:-${OUTPUT_STORAGE_ROOT}/logs/tagged_acl_new_v9_hn1024_tau000_raw_zh_lm4_${RUN_STAMP}}"
INDEX_CACHE_DIR="${INDEX_CACHE_DIR:-/mnt/gemini/data1/jiaxuanluo/maxsim_index_cache}"
EVAL_TMPDIR_OVERRIDE="${EVAL_TMPDIR_OVERRIDE:-/mnt/taurus/data2/jiaxuanluo/tmp/jx_tacl04}"

GPU_PAIRS_CSV="${GPU_PAIRS_CSV:-2,3}"
LMS="${LMS:-4}"
...
validate_tags() {
  local tags=(
    ...
    "variant:new_v9_hn1024_tau000_lm4"
    "compute:aries_gpu23_lm4"
  )
  local tag
  for tag in "${tags[@]}"; do
...
WANDB_COMPUTE_TAG_OVERRIDE="compute:aries_gpu23_lm4" \
...
out_dir="${OUT_ROOT}/${MODEL_LABEL}/zh/dtagacl_new_v9_hn1024_tau000_lm4_k10_th0.0_gacl6060_tagged_gt_raw_min_norm2"
...
echo "[ALL DONE] Tagged ACL New V9 HN1024 tau0.0 raw zh lm4 complete"
