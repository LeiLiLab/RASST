...
RUN_STAMP="${RUN_STAMP:-20260524T0630_de_hardraw_newv9_hn1024_tau078}"
...
MODEL_NAME="${MODEL_NAME_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/slm/speech_llm_new_v9_assistant_termtag_delay_clean_no_gt_zero_oldnewv3_de_r32a64_tp2_taurus4/keep1.0_r32/v0-20260524-121145-hf}"
MODEL_LABEL="${MODEL_LABEL_OVERRIDE:-newv9_de_r32a64}"
...
OUTPUT_BASE="${OUTPUT_BASE_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/medicine_hardraw_de_hn1024_tau078_new_v9_lm1to4_5samples_${RUN_STAMP}}"
LOG_ROOT="${LOG_ROOT_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/logs/medicine_hardraw_de_hn1024_tau078_new_v9_lm1to4_5samples_${RUN_STAMP}}"
INDEX_CACHE_DIR="${INDEX_CACHE_DIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/maxsim_index_cache/medicine_hardraw_de_hn1024_tau078_new_v9_${RUN_STAMP}}"
EVAL_TMPDIR="${EVAL_TMPDIR_OVERRIDE:-/tmp/jxmdde_${RUN_STAMP_SHORT}}"
DENSITY_TAG="${DENSITY_TAG_OVERRIDE:-medhard5_newv9_de_hn1024_tau0p78_raw}"

for p in "${ROOT_DIR}" "${BATCH_LAUNCHER}" "${MODEL_NAME}" "${HN1024_CKPT}" "${HARD_RAW_GLOSSARY}"; do
  if [[ ! -e "${p}" ]]; then
