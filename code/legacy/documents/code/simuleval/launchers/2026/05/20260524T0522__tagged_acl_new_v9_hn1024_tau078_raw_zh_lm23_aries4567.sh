...
# Speech LLM new_v9, HN1024 lh1b88kw retriever, raw glossary, lm=2 and lm=3.
# Runs two 2-GPU workers concurrently on Aries GPU pairs 4,5 and 6,7.
...
RUN_STAMP="${RUN_STAMP:-20260524T0522_tagacl_newv9_hn1024_tau078_raw_zh_lm23_aries4567}"
...
NOTES_FILE="${NOTES_FILE:-${ROOT_DIR}/documents/code/simuleval/notes/2026/05/20260524T0522__tagged_acl_new_v9_hn1024_tau078_raw_zh_lm23_aries4567.md}"

OUT_ROOT="${OUT_ROOT:-/mnt/gemini/data1/jiaxuanluo/tagged_acl_new_v9_hn1024_tau078_raw_zh_lm23_${RUN_STAMP}}"
LOG_ROOT="${LOG_ROOT:-/mnt/gemini/data1/jiaxuanluo/logs/tagged_acl_new_v9_hn1024_tau078_raw_zh_lm23_${RUN_STAMP}}"
INDEX_CACHE_DIR="${INDEX_CACHE_DIR:-/mnt/gemini/data1/jiaxuanluo/maxsim_index_cache}"
EVAL_TMPDIR_OVERRIDE="${EVAL_TMPDIR_OVERRIDE:-/mnt/gemini/data1/jiaxuanluo/tmp/tacl0522_lm23}"
...
validate_tags() {
  local tags=(
    ...
    "variant:new_v9_hn1024_tau078_zh_raw_lm23"
    "compute:aries_direct_gpu4567"
  )
  local tag
  for tag in "${tags[@]}"; do
...
WANDB_COMPUTE_TAG_OVERRIDE="compute:aries_direct_gpu4567" \
...
for lm in 2 3; do
  out_dir="${OUT_ROOT}/${MODEL_LABEL}/zh/dtagacl_new_v9_hn1024_tau078_lm${lm}_k10_th0.78_gacl6060_tagged_gt_raw_min_norm2"
...
echo "[ALL DONE] Tagged ACL New V9 HN1024 tau0.78 raw zh lm2/lm3 complete"
