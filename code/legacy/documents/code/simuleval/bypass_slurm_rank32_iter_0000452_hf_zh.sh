...
MODEL_NAME_DEFAULT="/mnt/gemini/data/jiaxuanluo/Omni-30B-sampling-0107/keep1.0_r32/v3-20260108-045345/iter_0000452-hf"
MODEL_NAME_OVERRIDE="${MODEL_NAME_OVERRIDE:-}"
MODEL_NAME="${MODEL_NAME_OVERRIDE:-${MODEL_NAME_DEFAULT}}"
# try 4 epoch results
#MODEL_NAME="/mnt/gemini/data/jiaxuanluo/Omni-30B-sampling-0107/keep1.0_r32/v3-20260108-045345-hf"
...
# Output
OUTPUT_BASE="/mnt/gemini/data2/jiaxuanluo/infinisst_omni_vllm_rag_rank32_iter_0000452_hf_zh_bypass_slurm"
CLEAN_OUTPUT_DIR="1"
...
print(max(1, int(float("${MAX_CACHE_SECONDS}") / chunk)))
PY
)"
KEEP_CACHE_CHUNKS="$(
python3 - <<PY
chunk=float("${VLLM_SEGMENT_SEC}")
print(max(1, int(float("${KEEP_CACHE_SECONDS}") / chunk)))
PY
)"
