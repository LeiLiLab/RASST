...
# Run SimulEval for the "paper extracted glossary" but *per talk/paper* (rank16 v3 HF model):
# - Use pre-generated per-paper glossaries (manifest-driven)
# - Prepare per-paper dev.source/dev.target subsets
# - For each paper_id, run the rank16 sweep script with overrides:
#   - GLOSSARY_PATHS_OVERRIDE
#   - SRC_LIST_OVERRIDE / TGT_LIST_OVERRIDE
#   - MODEL_NAME_OVERRIDE / OUTPUT_BASE_OVERRIDE (optional)
#
...
OUTPUT_BASE_DEFAULT="/mnt/gemini/data2/jiaxuanluo/infinisst_omni_vllm_rag_rank16_v3-20260121-021342-hf_zh_k1_10_k2_sweep_glossary2"
...
# GPU selection override for rank16 base script (physical ids, e.g. "4,5")
