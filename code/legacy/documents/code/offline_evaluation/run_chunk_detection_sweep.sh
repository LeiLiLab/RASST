...
#SBATCH --output=/mnt/gemini/data1/jiaxuanluo/logs/%j_chunk_det.out
#SBATCH --error=/mnt/gemini/data1/jiaxuanluo/logs/%j_chunk_det.err
...
SCRIPT="/mnt/taurus/home/jiaxuanluo/InfiniSST/documents/code/offline_evaluation/chunk_detection_sweep.py"
# ======Configuration=====

echo "[EVAL] Chunk-level has_term detection sweep"
