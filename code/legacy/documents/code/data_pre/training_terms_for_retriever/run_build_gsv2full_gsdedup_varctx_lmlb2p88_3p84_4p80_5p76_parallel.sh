...
export DIAG_JSON="${DIAG_JSON:-/mnt/gemini/home/jiaxuanluo/term_train_3variant_gsv2_full0_31_clean_mfa_gsrepaired_gsdedup_varctx2p88_3p84_4p80_5p76_diag.json}"

export DURATION_SECS="${DURATION_SECS:-2.88 3.84 4.80 5.76}"
export DURATION_ASSIGNMENT="${DURATION_ASSIGNMENT:-balance_rows}"
export LOG_DIR="${LOG_DIR:-/mnt/gemini/home/jiaxuanluo/logs/varctx_lmlb_shards}"

exec bash "${SCRIPT_DIR}/run_build_gsv2full_gsdedup_varctx_0p96_1p92_2p88_3p84_parallel.sh"
