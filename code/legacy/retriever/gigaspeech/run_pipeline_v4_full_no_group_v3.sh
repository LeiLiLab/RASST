...
#SBATCH --output=/mnt/taurus/home/jiaxuanluo/InfiniSST/retriever/gigaspeech/modal/logs/%j_v4_taurus.out
#SBATCH --error=/mnt/taurus/home/jiaxuanluo/InfiniSST/retriever/gigaspeech/modal/logs/%j_v4_taurus.err
...
NER_CANDIDATES_OUTPUT="/mnt/gemini/data1/jiaxuanluo/ner_candidates_${SPACY_MODEL}.jsonl"
...
if [[ "$MODE" == "merge0" ]]; then merge_shards "${NER_CANDIDATES_OUTPUT}"; fi
