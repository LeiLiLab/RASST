#!/bin/bash
#SBATCH --job-name=v4_taurus_pipeline_de
#SBATCH --nodes=1
...
#SBATCH --output=/mnt/taurus/home/jiaxuanluo/InfiniSST/retriever/gigaspeech/modal/logs/%j_v4_taurus_for_de.out
#SBATCH --error=/mnt/taurus/home/jiaxuanluo/InfiniSST/retriever/gigaspeech/modal/logs/%j_v4_taurus_for_de.err
...
# =======================
INPUT_GT_STAGE1="/mnt/gemini/data/jiaxuanluo/manifests_rag/train_s_de_baseline.jsonl"
INPUT_TSV="/mnt/gemini/data1/jiaxuanluo/train_xl_case_robust_asr-filtered_de_metricx-qe3.0_align.tsv"
NER_CANDIDATES_OUTPUT="/mnt/gemini/data1/jiaxuanluo/train_s_de_ner_candidates_${SPACY_MODEL}.jsonl"
STAGE1_OUTPUT="/mnt/gemini/data1/jiaxuanluo/train_s_de_v4_ner_baseline_aligned_${SAMPLING_STR}.jsonl"
STAGE2_OUTPUT_BASE="/mnt/gemini/data1/jiaxuanluo/train_s_de_v4_ner_baseline_aligned_${SAMPLING_STR}_final"
TARGET_LANG_CODE="de"
