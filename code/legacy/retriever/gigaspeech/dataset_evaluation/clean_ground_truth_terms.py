...
def main():
    ...
    parser.add_argument('--glossary', required=False, default='/home/jiaxuanluo/InfiniSST/retriever/gigaspeech/data/terms/glossary_merged.json', help='Path to glossary_merged.json')
    parser.add_argument('--input-dir', required=False, default='/home/jiaxuanluo/InfiniSST/retriever/gigaspeech/data/samples/test', help='Directory containing term_preprocessed_samples files')
    parser.add_argument('--output-dir', required=False, default='/home/jiaxuanluo/InfiniSST/retriever/gigaspeech/data/samples/test_cleaned', help='Output directory for cleaned files')
    ...
    all_files = [
        'term_preprocessed_samples_test.json'
    ]
