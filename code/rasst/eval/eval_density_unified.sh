...
RAG_USE_MAXSIM_OVERRIDE="${RAG_USE_MAXSIM_OVERRIDE:-1}"
RAG_POOLING_TYPE_OVERRIDE="${RAG_POOLING_TYPE_OVERRIDE:-transformer}"
...
echo "[INFO] RAG_USE_MAXSIM=${RAG_USE_MAXSIM_OVERRIDE} RAG_POOLING_TYPE=${RAG_POOLING_TYPE_OVERRIDE}"
...
if [[ "${BASELINE_NO_RAG}" == "1" ]]; then
  ...
  AGENT_TERM_ARGS=(
    ...
    --rag-use-maxsim "${RAG_USE_MAXSIM_OVERRIDE}"
    --rag-pooling-type "${RAG_POOLING_TYPE_OVERRIDE}"
