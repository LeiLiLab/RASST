...
The frozen source table recorded by the manifest is:

```text
/mnt/taurus/data2/jiaxuanluo/RASST/code/legacy/documents/code/simuleval/reports/20260524_main_result_data.tsv
```

The full TSV preserves the submitted-paper exact RASST rows. The German TSV is a
convenience slice. The check TSV verifies that the rounded table metrics match
each recorded `eval_results.tsv` source path.
...
| Runner | Driver |
| --- | --- |
| `serial_simuleval` | `/mnt/taurus/data2/jiaxuanluo/RASST/code/legacy/documents/code/simuleval/eval_density_unified.sh` |
| `batch_vllm` | `/mnt/taurus/data2/jiaxuanluo/RASST/code/legacy/documents/code/simuleval/launchers/2026/05/20260524__batched_vllm_rag_eval.sh` |
...
| `model_zh_new_v9` | `/mnt/taurus/data2/jiaxuanluo/RASST/checkpoints/slm/zh_new_v9/v0-20260524-062743-hf` |
...
`max_new_tokens` is the manifest override. When `token_policy=lm_scaled`, the
override is the base value and the effective decoding cap is scaled by `lm`.

| Domain | Lang | lm | Runner | Model | max_new_tokens | token_policy | audio_limit | max_model_len | cache max/keep | Provenance event |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `acl_tagged_raw` | `zh` | 1 | `batch_vllm` | `model_zh_new_v9` | 256 | `fixed` | 128 | 16384 | 16/8 | `20260524T1442__simuleval__tagged_acl_same_lm_batch_v1exact_hn1024_tau078_raw_zh_lm1_max256` |
| `acl_tagged_raw` | `zh` | 2 | `batch_vllm` | `model_zh_new_v9` | 40 | `lm_scaled` | 128 | manifest default | 16/8 | `20260524T0522__simuleval__tagged_acl_new_v9_hn1024_tau078_raw_zh_lm23_aries4567` |
| `acl_tagged_raw` | `zh` | 3 | `batch_vllm` | `model_zh_new_v9` | 40 | `lm_scaled` | 128 | manifest default | 16/8 | `20260524T0522__simuleval__tagged_acl_new_v9_hn1024_tau078_raw_zh_lm23_aries4567` |
| `acl_tagged_raw` | `zh` | 4 | `batch_vllm` | `model_zh_new_v9` | 40 | `lm_scaled` | 128 | manifest default | 16/8 | `20260524T0555__simuleval__tagged_acl_new_v9_hn1024_tau078_raw_zh_lm4_aries45` |
...
| `acl_tagged_raw` | `de` | 3 | `batch_vllm` | `model_de_cap16_denoise` | 40 | `lm_scaled` | 128 | manifest default | 30/30 | `20260525T172158__simuleval__de_acl_lm23_then_ja_medicine_cap16_denoise_aries` |
| `acl_tagged_raw` | `de` | 4 | `serial_simuleval` | `model_de_cap16_denoise` | 160 | `fixed` | auto | 12288 | 30/30 | `20260526T020512__simuleval__tagged_acl_de_lm4_serial_promptfix_audioauto_cache30_max40lm_taurus_direct` |
...
| `acl_tagged_raw` | `ja` | 3 | `serial_simuleval` | `model_ja_cap16_denoise` | 120 | `fixed` | 128 | 12288 | 30/30 | `20260526T013751__simuleval__tagged_acl_ja_lm1to4_serial_promptfix_cache30_vllmaudio128_max40lm_taurus` |
| `acl_tagged_raw` | `ja` | 4 | `serial_simuleval` | `model_ja_cap16_denoise` | 160 | `fixed` | 128 | 12288 | 30/30 | `20260526T013751__simuleval__tagged_acl_ja_lm1to4_serial_promptfix_cache30_vllmaudio128_max40lm_taurus` |
| `medicine_hardraw` | `zh` | 1 | `serial_simuleval` | `model_zh_new_v9` | 40 | `fixed` | 8 | 8192 | 30/30 | `20260524T0242__simuleval__medicine_hardraw_hn1024_tau078_new_v9_batch` |
| `medicine_hardraw` | `zh` | 2 | `serial_simuleval` | `model_zh_new_v9` | 40 | `fixed` | 8 | 8192 | 30/30 | `20260524T0242__simuleval__medicine_hardraw_hn1024_tau078_new_v9_batch` |
| `medicine_hardraw` | `zh` | 3 | `serial_simuleval` | `model_zh_new_v9` | 40 | `fixed` | 8 | 8192 | 30/30 | `20260524T0242__simuleval__medicine_hardraw_hn1024_tau078_new_v9_batch` |
| `medicine_hardraw` | `zh` | 4 | `serial_simuleval` | `model_zh_new_v9` | 40 | `fixed` | 8 | 8192 | 30/30 | `20260524T0242__simuleval__medicine_hardraw_hn1024_tau078_new_v9_batch` |
...
| `medicine_hardraw` | `de` | 3 | `batch_vllm` | `model_de_cap16_denoise` | 40 | `lm_scaled` | 128 | 12288 | 30/30 | `20260525T170456__simuleval__medicine_de_cap16_denoise_lm34_batch_taurus03` |
| `medicine_hardraw` | `de` | 4 | `serial_simuleval` | `model_de_cap16_denoise` | 160 | `fixed` | auto | 12288 | 30/30 | `20260526T043300__simuleval__medicine_de_lm4_serial_promptfix_cache30_audioauto_max40lm_taurus23` |
...
| `medicine_hardraw` | `ja` | 3 | `batch_vllm` | `model_ja_cap16_denoise` | 40 | `lm_scaled` | 128 | 12288 | 30/30 | `20260525T1840__simuleval__medicine_ja_cap16_denoise_lm1234_batch_taurus` |
| `medicine_hardraw` | `ja` | 4 | `batch_vllm` | `model_ja_cap16_denoise` | 40 | `lm_scaled` | 128 | 12288 | 30/30 | `20260525T1840__simuleval__medicine_ja_cap16_denoise_lm1234_batch_taurus` |
